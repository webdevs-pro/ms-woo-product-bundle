...
jQuery('body').
    on('click touch', '.woosb_item_checkbox',
        function() {
          // var qty_input = jQuery(this).closest('.woosb-product').find('.input-text.qty.text');

          var product_qty_val = jQuery(this).closest('.woosb-product').find('.woosb-qty').attr('data-qty');

          if(jQuery(this).prop("checked") == true) {
            jQuery(this).closest('.woosb-product').find('.input-text.qty.text').val(product_qty_val);
            jQuery(this).closest('.woosb-product').find('.input-text.qty.text').trigger('change');
          } else {
            jQuery(this).closest('.woosb-product').find('.input-text.qty.text').val('0');
            jQuery(this).closest('.woosb-product').find('.input-text.qty.text').trigger('change');
          }
