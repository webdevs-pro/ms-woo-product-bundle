...
if ( ! class_exists( 'MSleverDashboard' ) ) {
	class MSleverDashboard {
		...
		function enqueue_scripts() {
			wp_enqueue_style( 'wpc-dashboard', MS_URI . 'assets/css/dashboard.css' );
		}

		function add_dashboard_widget() {
			wp_add_dashboard_widget( 'wpclever_dashboard_widget', 'MSlever.net Plugins', array(
				&$this,
