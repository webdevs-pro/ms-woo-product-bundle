...
If you have created your own language pack, or have an update for an existing one, you can send [gettext PO and MO file](http://codex.wordpress.org/Translating_WordPress "Translating WordPress") to [us](https://wpclever.net/contact?utm_source=pot&utm_medium=woosb&utm_campaign=wporg "MSlever.net") so we can bundle it into MS Product Bundles.

= Not what you needed? =

Please try other plugins from us:

- [MS Composite Products](https://wordpress.org/plugins/wpc-composite-products/ "MS Composite Products")
- [MS Grouped Product](https://wordpress.org/plugins/wpc-grouped-product/ "MS Grouped Product")
- [MS Frequently Bought Together](https://wordpress.org/plugins/woo-bought-together/ "MS Frequently Bought Together")
- [MS Force Sells](https://wordpress.org/plugins/wpc-force-sells/ "MS Force Sells")
...
3. Search for "MS Product Bundles", Install & Activate it
...
= 5.2.5 =
* Fixed: JS error for MS Smart Quick View
...
* Fixed: Compatible with MS Ajax Add to Cart
* Fixed: Some minor CSS & JS issues

= 5.1.2 =
* Fixed: Compatible with MS Variations Radio Buttons
...
* Fixed: Calculate total when using MS Frequently Bought Together
...
* Fixed: Compatible with MS Product Quantity

= 3.7.0 =
* Added: Compatible with MS Variations Radio Buttons
* Fixed: Some minor CSS & JS issues
...
* Updated: Work with MS Smart Quick View
...
= 2.5.4 =
* Added: Welcome page for all plugins from MSlever
